...
// change Scene to PlayingScene
void SelectingScene::changescene_to_play_saber(Ref* sender) {

	auto scene = PlayingScene::createSceneWithHero(ARTHUR);
	Director::getInstance()->replaceScene(scene);
}

void SelectingScene::changescene_to_play_archer(Ref* sender) {

	auto scene = PlayingScene::createSceneWithHero(HOUYI);
	Director::getInstance()->replaceScene(scene);
}

void SelectingScene::changescene_to_play_caster(Ref* sender) {

	auto scene = PlayingScene::createSceneWithHero(DAJI);
	Director::getInstance()->replaceScene(scene);
}
/*
...
bool SelectingScene::init()
{
	...
	auto SABER_button = MenuItemSprite::create(
		SABER_button1,
		SABER_button2,
		CC_CALLBACK_1(SelectingScene::changescene_to_play_saber, this));

	auto ARCHER_button = MenuItemSprite::create(
		ARCHER_button1,
		ARCHER_button2,
		CC_CALLBACK_1(SelectingScene::changescene_to_play_archer, this));

	auto CASTER_button = MenuItemSprite::create(
		CASTER_button1,
		CASTER_button2,
		CC_CALLBACK_1(SelectingScene::changescene_to_play_caster, this));
